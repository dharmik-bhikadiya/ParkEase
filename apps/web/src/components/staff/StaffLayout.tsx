...
export const StaffLayout: React.FC<StaffLayoutProps> = ({
  ...
  const navItems = [
    ...
    { label: 'Gate Scanner', path: '/staff/gate-scan', icon: QrCode },
    { label: 'Active Sessions', path: '/staff/sessions', icon: Car },
    { label: 'Parking Slots', path: '/staff/slots', icon: Layers },
    { label: 'Staff Profile', path: '/staff/profile', icon: UserIcon },
    { label: 'Main Site (Home)', path: '/', icon: Globe },
  ];

  const bottomNavItems = [
    { label: 'Dashboard', path: '/staff', icon: LayoutDashboard },
    { label: 'Scanner', path: '/staff/gate-scan', icon: QrCode },
    { label: 'Sessions', path: '/staff/sessions', icon: Car },
    { label: 'Slots', path: '/staff/slots', icon: Layers },
  ];
      ...
      <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-[#E8F6EC] px-4 md:px-8 py-3 shadow-xs">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="inline-flex items-center gap-1 text-[11px] font-extrabold px-2.5 py-0.5 rounded-full bg-blue-100 text-blue-800 border border-blue-300 uppercase tracking-wide">
              <ShieldAlert className="w-3.5 h-3.5 text-blue-700" /> STAFF PORTAL
            </span>
          </div>
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/staff/gate-scan"
              className="flex items-center gap-1.5 px-3 py-1.5 bg-[#176B4D] text-white text-xs font-bold rounded-xl shadow-xs hover:bg-[#12543c] transition-all"
            >
              ...
              <div>
                <div className="flex items-center justify-between pb-4 border-b border-gray-100">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-black text-lg text-[#18342A]">Staff Portal</span>
                  </div>
